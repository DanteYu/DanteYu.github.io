...
QA在这一轮需要考虑上面哪些测试技术适用于当前的故事卡，把适合的测试技术与故事卡的变动联系起来，确定了针对本次改动的测试范围和基本测试点。上面提到这九种技术是非常通用的，如果发现故事卡有需求变动不能被这九种技术覆盖掉，那么QA需要考虑自己“创造”一种测试技术来覆盖需求。

此轮测试相比于RST，这一轮测试会涉及更多业务领域知识，最基本的业务功能都会在此轮测试中被覆盖到。
