...
在最近几年的工作中，项目都是离岸交付的敏捷项目，工作时间越长我越会思考我理想的项目是什么？我想在什么样的项目下工作来帮助个人的成功？不同的项目是否有着相似的特点？是否存在一个“标准化”的项目实践来指导我们把项目做好？
...
* Leverage
  * 需要有匹配项目类型的lead,senior,junior比例
* Rotation
  * trust and relationship build
  * 能切身体会offshore/onshore同事的工作习惯和环境，发现改进点
...
* rewards / recognition
* team achievement
* more offshore involvement in key activities - design  decision making  Inception
...
* automation testing
* TDD
* clear release / flight plan - visualization
* RAID risk assumption issue dependency
* velocity planning
* MVP priority
* Working in progress limitation
* Story principle "INVEST"
* CFR management
* decision register
* iteration report
